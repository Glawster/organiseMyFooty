...
Runtime logging uses `organiseMyProjects.logUtils`. That package must already
be available in the same Python environment; the application does not install
